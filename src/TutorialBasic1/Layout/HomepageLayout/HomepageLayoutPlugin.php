    ...
    class HomepageLayoutPlugin implements Plugin  {
        ...
        public function onContextInit(Context $context)
        {
            if ($context instanceof HomepageContext) {
                $context->useTemplate("template.mainLayout", __DIR__ . "/tpl/MainLayout.tpl.html");
                $context->useTemplate("template.mainLayout.navBarTop", __DIR__ . "/tpl/NavBarTop.partial.html");

                // Hier können sich alle Plugins mit CSS AssetSets registrieren
                $context->useAssetSetList("assetSetList.css", new GoCssAssetHandler());

                // Der eigenltiche Asset-Satz, der für diesen Controller integriert werden soll
                $context->useAssetSet("assetSet.mainStyle.css", __DIR__ . "/tpl/assets/css", "*.css", new GoCssAssetRenderer());
                $context->useAssetSet("assetSet.mainStyle.scss", __DIR__ . "/tpl/assets/scss", "*.scss", new GoScssAssetRenderer());
